...
% for more info) . 
%
% In order to use SA_Taliro to perform random walk in the search space,
% use the following options (See SA_Taliro_parameters):
%       betaXStart = 1;
%       dispStart = 1;
%       nEvalAdapt = n_tests;
%
...
% mgoyal CHANGED for CAV
params.nEvalAdapt = 10;


% disp(params.nEvalAdapt);
